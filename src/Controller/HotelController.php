...
class HotelController extends Controller
{
    ...
    /**
     * @Route("/hotels", name="front_hotels")
     */
     public function show()
     {
       $hotels = $this->getDoctrine()
                          ...
                          ->findAll();
       // print items with {{ hotels }}
      return $this->render('frontinterface/hotels/listhotels.html.twig',
            ['hotels' => $hotels]);
     }

    /**
     * @Route("/hotels/{name}", name="front_hotel_info")
     */
    public function hotel($name)
    {
        ...
        $hotel = $repository->findOneBy(['libelle' => $name]);

        if (!$hotel) {
            throw $this->createNotFoundException(
                'Pas de hotel trouvé portant le nom : '.$name
            );
        }

        return $this->render('frontinterface/hotels/infohotel.html.twig',
            ['hotel' => $hotel]);
