...
{
    /**
     * @Route("/restaurants", name="front_restaurants")
     */
     public function show()
     {
       $restaurants = $this->getDoctrine()
                          ...
                          ->findAll();
       // print items with {{ restaurants }}
      return $this->render('frontinterface/restaurants/listrestaurants.html.twig',
            ['restaurants' => $restaurants]);
     }

    /**
     * @Route("/restaurants/{name}", name="front_restaurant_info")
     */
    public function restaurant($name)
    {
        ...
        $restaurant = $repository->findOneBy(['libelle' => $name]);

        if (!$restaurant) {
            throw $this->createNotFoundException(
                'Pas de restaurant trouvé portant le nom : '.$name
            );
        }

        return $this->render('frontinterface/restaurants/inforestaurant.html.twig',
