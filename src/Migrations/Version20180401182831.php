 ...
 */
class Version20180401182831 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE app_attraction (id INTEGER NOT NULL, type INTEGER DEFAULT NULL, libelle VARCHAR(65) NOT NULL COLLATE BINARY, taillemini DOUBLE PRECISION NOT NULL, age INTEGER NOT NULL, description CLOB NOT NULL COLLATE BINARY, image VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_83184DC48CDE5729 FOREIGN KEY (type) REFERENCES type_attraction (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE app_attraction');
        $this->addSql('CREATE TABLE app_attraction (id INTEGER NOT NULL, libelle VARCHAR(65) NOT NULL, taillemini DOUBLE PRECISION NOT NULL, age INTEGER NOT NULL, description CLOB NOT NULL, image VARCHAR(255) NOT NULL, type_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
